...
export function buildChartPrompt(): string {
  return [
    ...
    "```",
    "",
    "Supported types: `bar` (compare values), `line` (trends over time), `area` (cumulative/proportional), `pie` (parts of a whole).",
    "",
    "For `pie` charts, `xKey` is the slice label and only the first `series` entry is used as the slice value. Slice colors are assigned automatically:",
    "",
    "```chart",
    '{',
    '  "type": "pie",',
    ...
    '  "data": [',
    '    { "channel": "Airbnb", "bookings": 42 },',
    '    { "channel": "Direct", "bookings": 18 }',
    '  ]',
    '}',
    "```",
    "",
