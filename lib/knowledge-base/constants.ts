...
export const KNOWLEDGE_BASE_SEARCH_TOOL_NAME = "search_knowledge_base";

export const KNOWLEDGE_BASE_SEARCH_TOP_K = 20;

export const KNOWLEDGE_BASE_SEARCH_RERANK_TOP_N = 8;

export const KNOWLEDGE_BASE_SEARCH_RERANK_MODEL = "bge-reranker-v2-m3";

export const KNOWLEDGE_BASE_QUERY_STRATEGY_MODEL =
  process.env.KNOWLEDGE_BASE_QUERY_STRATEGY_MODEL?.trim() ||
  KNOWLEDGE_BASE_CLASSIFIER_MODEL;

export const KNOWLEDGE_BASE_MULTI_QUERY_VARIANT_COUNT = 2;
