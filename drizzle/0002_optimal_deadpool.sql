...
--> statement-breakpoint
CREATE INDEX "tools_workspace_id_idx" ON "tools" USING btree ("workspace_id");
--> statement-breakpoint
CREATE INDEX "tools_tool_id_idx" ON "tools" USING btree ("tool_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "tools_workspace_id_tool_key_idx" ON "tools" USING btree ("workspace_id","tool_key");